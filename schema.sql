...
OrdePlaced    DATE not null,
PRIMARY KEY (OrderID),
CHECK(OrderType='InStore'OROrderType='Collection'OR OrderType='Delivery' ),
...
FOREIGN KEY(ProctID) REFERENCES ORDERS(ProctID) ON DELETE SET NULL ON UPDATE CASCADE,
);
DROP TABLE DELEVERIES CASCADE;
...
DROP TABLE STAFF_ORDER CASCADE;
